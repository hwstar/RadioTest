...
class Tab_Harm_Spur(gc.GuiCommon):
    ...
    def sa_clicked_callback(self):
        ...
        self.instr_radiobutton_handler(self.sa_instr_info, self.test_button_enable,
    ...
    def reset(self):
        ...
        self.reset_instrument_select(self.sa_instr_info, self.test_button_enable, self.sa_int_var)
